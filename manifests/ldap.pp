...
class keystone::ldap(
  ...
  File['/etc/keystone/domains'] -> Keystone_config<||>

  keystone_config {
    'ldap/url':                                  value => $url, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user':                                 value => $user, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/password':                             value => $password, secret => true, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/suffix':                               value => $suffix, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/query_scope':                          value => $query_scope, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/page_size':                            value => $page_size, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_tree_dn':                         value => $user_tree_dn, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_filter':                          value => $user_filter, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_objectclass':                     value => $user_objectclass, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_id_attribute':                    value => $user_id_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_name_attribute':                  value => $user_name_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_mail_attribute':                  value => $user_mail_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_attribute':               value => $user_enabled_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_mask':                    value => $user_enabled_mask, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_default':                 value => $user_enabled_default, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_invert':                  value => $user_enabled_invert, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_attribute_ignore':                value => $user_attribute_ignore, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_default_project_id_attribute':    value => $user_default_project_id_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_allow_create':                    value => $user_allow_create, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_allow_update':                    value => $user_allow_update, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_allow_delete':                    value => $user_allow_delete, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_pass_attribute':                  value => $user_pass_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_emulation':               value => $user_enabled_emulation, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_enabled_emulation_dn':            value => $user_enabled_emulation_dn, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/user_additional_attribute_mapping':    value => $user_additional_attribute_mapping, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_tree_dn':                      value => $project_tree_dn_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_filter':                       value => $project_filter_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_objectclass':                  value => $project_objectclass_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_id_attribute':                 value => $project_id_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_member_attribute':             value => $project_member_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_desc_attribute':               value => $project_desc_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_name_attribute':               value => $project_name_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_enabled_attribute':            value => $project_enabled_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_attribute_ignore':             value => $project_attribute_ignore_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_domain_id_attribute':          value => $project_domain_id_attribute_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_allow_create':                 value => $project_allow_create_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_allow_update':                 value => $project_allow_update_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_allow_delete':                 value => $project_allow_delete_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_enabled_emulation':            value => $project_enabled_emulation_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_enabled_emulation_dn':         value => $project_enabled_emulation_dn_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/project_additional_attribute_mapping': value => $project_additional_attribute_mapping_real, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_tree_dn':                         value => $role_tree_dn, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_filter':                          value => $role_filter, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_objectclass':                     value => $role_objectclass, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_id_attribute':                    value => $role_id_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_name_attribute':                  value => $role_name_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_member_attribute':                value => $role_member_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_attribute_ignore':                value => $role_attribute_ignore, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_allow_create':                    value => $role_allow_create, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_allow_update':                    value => $role_allow_update, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_allow_delete':                    value => $role_allow_delete, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/role_additional_attribute_mapping':    value => $role_additional_attribute_mapping, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_tree_dn':                        value => $group_tree_dn, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_filter':                         value => $group_filter, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_objectclass':                    value => $group_objectclass, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_id_attribute':                   value => $group_id_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_name_attribute':                 value => $group_name_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_member_attribute':               value => $group_member_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_desc_attribute':                 value => $group_desc_attribute, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_attribute_ignore':               value => $group_attribute_ignore, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_allow_create':                   value => $group_allow_create, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_allow_update':                   value => $group_allow_update, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_allow_delete':                   value => $group_allow_delete, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/group_additional_attribute_mapping':   value => $group_additional_attribute_mapping, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/use_tls':                              value => $use_tls, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/tls_cacertdir':                        value => $tls_cacertdir, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/tls_cacertfile':                       value => $tls_cacertfile, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/tls_req_cert':                         value => $tls_req_cert, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/use_pool':                             value => $use_pool, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/pool_size':                            value => $pool_size, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/pool_retry_max':                       value => $pool_retry_max, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/pool_retry_delay':                     value => $pool_retry_delay, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/pool_connection_timeout':              value => $pool_connection_timeout, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/pool_connection_lifetime':             value => $pool_connection_lifetime, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/use_auth_pool':                        value => $use_auth_pool, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/auth_pool_size':                       value => $auth_pool_size, path => '/etc/keystone/domains/keystone.Default.conf';
    'ldap/auth_pool_connection_lifetime':        value => $auth_pool_connection_lifetime, path => '/etc/keystone/domains/keystone.Default.conf';
    'identity/driver':                           value => $identity_driver, path => '/etc/keystone/domains/keystone.Default.conf';
    'credential/driver':                         value => $credential_driver, path => '/etc/keystone/domains/keystone.Default.conf';
    'assignment/driver':                         value => $assignment_driver, path => '/etc/keystone/domains/keystone.Default.conf';
  }
}
